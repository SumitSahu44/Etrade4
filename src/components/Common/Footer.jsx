...
export const Footer = () => (
  <footer className="bg-[#1A1A1A] text-white pt-24 pb-12 rounded-t-[4rem] relative overflow-hidden">
    {/* Decorative Elements */}
    <div className="absolute top-0 right-0 w-96 h-96 bg-[#a58c67]/10 rounded-full blur-[100px] -mr-48 -mt-48"></div>
    <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#a58c67]/5 rounded-full blur-[80px] -ml-32 -mb-32"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-16 border-b border-white/5">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4">
            {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
              <a key={i} href="#" className="w-10 h-10 border border-white/10 rounded-xl flex items-center justify-center hover:bg-[#a58c67] hover:border-[#a58c67] transition-all duration-300">
                <Icon size={18} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="grid gap-4 text-sm font-bold text-gray-400">
            ...
            <li><Link to="/trade-enquiry" className="hover:text-white transition-colors flex items-center gap-2 group"><ExternalLink size={14} className="text-[#a58c67] group-hover:scale-110 transition-transform" /> Trade Enquiry</Link></li>
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 gap-4 text-sm font-bold text-gray-400">
            ...
            <li className="col-span-2 mt-2"><Link to="/terms" className="text-[#a58c67] flex items-center gap-2 hover:underline"><ShieldCheck size={16} /> e-Trade T&C</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-8">
          <div>
            <h4 className="text-sm font-extrabold uppercase tracking-[0.3em] text-[#a58c67] mb-6">Headquarters</h4>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="h-20 bg-white/5 rounded-2xl border border-white/5 flex flex-col items-center justify-center group cursor-pointer hover:bg-white/10 transition-all">
              <Globe size={20} className="text-[#a58c67] mb-2" />
              <span className="text-[9px] font-extrabold uppercase er">India Map</span>
            </div>
            <div className="h-20 bg-white/5 rounded-2xl border border-white/5 flex flex-col items-center justify-center group cursor-pointer hover:bg-white/10 transition-all">
              <Phone size={20} className="text-[#a58c67] mb-2" />
