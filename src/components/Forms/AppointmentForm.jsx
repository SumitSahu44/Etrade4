  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-10 rounded-[3rem] shadow-2xl shadow-pink-100/50 border border-pink-50 relative overflow-hidden">
      ...
      <div className="mt-12 flex justify-center relative z-10">
        <button className="flex items-center gap-3 bg-[#bc114a] text-white px-16 py-5 rounded-full font-black text-xs uppercase tracking-[0.2em] hover:bg-black transition-all shadow-xl shadow-[#bc114a]/20 group">
