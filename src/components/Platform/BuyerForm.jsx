  ...
  return (
    <div className="max-w-5xl mx-auto bg-white p-10 rounded-[3rem] shadow-2xl shadow-pink-100/50 border border-pink-50">
      <div className="flex justify-between items-center mb-10 border-b border-pink-50 pb-6">
        ...
        <span className="text-[10px] bg-[#4A4A4A] text-white px-4 py-1 rounded-full font-bold uppercase tracking-widest">Registration Form</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Textile Items to Buy</label>
      ...
      <div className="mt-12 flex flex-wrap gap-4 justify-center">
        <button className="flex items-center gap-2 bg-[#FFF0F5] text-[#4A4A4A] px-10 py-4 rounded-full font-black text-xs uppercase tracking-widest hover:bg-[#4A4A4A] hover:text-white transition-all">
          <Eye size={16} /> Preview
        </button>
        <button className="flex items-center gap-2 bg-[#4A4A4A] text-white px-12 py-4 rounded-full font-black text-xs uppercase tracking-widest hover:bg-black transition-all shadow-xl shadow-gray-200">
