  ...
  return (
    <div className="min-h-screen bg-[#FFF0F5]/20 py-12">
      <div className="max-w-[95%] mx-auto text-center mb-12">
        <span className="text-[#4A4A4A] font-extrabold text-sm uppercase tracking-[0.5em]">Secure Trading</span>
        <h1 className="text-4xl font-extrabold text-[#4A4A4A] mt-2 uppercase er">
      ...
      <div className="max-w-4xl mx-auto mt-16 p-8 bg-white/50 rounded-[2rem] border border-pink-100 text-center">
        ...
        <p className="text-sm text-gray-400 leading-relaxed uppercase font-bold">
