      ...
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-1/3">
          <div className="sticky top-32">
            <span className="text-[#4A4A4A] font-extrabold text-sm uppercase tracking-[0.4em]">Fast Response</span>
            <h2 className="text-4xl font-extrabold text-[#4A4A4A] mt-2 leading-tight uppercase ">Request an <span className="text-[#4A4A4A] normal-case">e-Quotation</span></h2>
            ...
            <div className="mt-8 p-6 bg-white rounded-3xl border border-pink-100 shadow-sm">
               ...
               <p className="text-sm font-bold text-gray-400 uppercase leading-relaxed">Note: Quotations are valid for 7 days from the date of issuance due to market fluctuations.</p>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-2/3 bg-white p-10 md:p-16 rounded-[4rem] shadow-2xl border border-pink-50">
          <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-2">
              <label className="text-sm font-extrabold text-gray-400 uppercase tracking-wider ml-2">Product Category</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-extrabold text-gray-400 uppercase tracking-wider ml-2">Expected Quantity</label>
