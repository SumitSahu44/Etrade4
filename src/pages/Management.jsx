  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24 max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-3xl font-extrabold text-[#4A4A4A] uppercase ">Our Core <span className="text-[#a58c67]">Values</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {leaders.map((leader, i) => (
              <div key={i} className="bg-white p-12 rounded-[3.5rem] border border-pink-50 shadow-sm hover:shadow-2xl transition-all group">
                <div className="w-20 h-20 bg-[#4A4A4A] rounded-3xl flex items-center justify-center group-hover:bg-[#a58c67] transition-colors">
                  {leader.icon}
                </div>
