  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#4A4A4A] py-24 text-white text-center">
        <span className="text-[#bc114a] font-black text-xs uppercase tracking-[0.5em]">Executive Leadership</span>
        <h1 className="text-5xl font-black mt-4 uppercase tracking-tighter">Our <span className="text-[#bc114a]">Management</span></h1>
          ...
          <div className="grid grid-cols-2 gap-6 mt-10">
            <div className="flex gap-4 items-start">
               ...
               <div>
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase mt-1">First Priority</p>
               </div>
            </div>
            <div className="flex gap-4 items-start">
               ...
               <div>
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase mt-1">Modern Trade</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#4A4A4A] uppercase">The <span className="text-[#bc114a]">Pioneers</span></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {leaders.map((leader, i) => (
              <div key={i} className="bg-white p-12 rounded-[3.5rem] border border-pink-50 shadow-sm hover:shadow-2xl transition-all group">
                ...
                <h3 className="text-2xl font-black text-[#4A4A4A] mt-8">{leader.name}</h3>
                <p className="text-[#bc114a] text-xs font-black uppercase tracking-widest mt-2">{leader.role}</p>
