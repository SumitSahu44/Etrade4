...
export const Careers = () => (
  <div className="min-h-screen py-20 px-6">
    <div className="max-w-4xl mx-auto text-center">
      <Briefcase size={48} className="mx-auto text-[#db2777] mb-6" />
      <h2 className="text-4xl font-black text-[#db2777] uppercase italic">Join Our <span className="text-[#db2777]">Team</span></h2>
      ...
      <div className="mt-12 p-10 bg-[#FDF2F2] rounded-[3rem] border-2 border-dashed border-pink-200">
        <h4 className="text-xl font-bold text-[#db2777]">Current Openings</h4>
        <p className="text-gray-400 mt-2 italic text-sm">No active positions at the moment.</p>
