    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-[#db2777] leading-tight">
            Our Management <br /> & <span className="text-[#db2777]">Expertise</span>
          </h2>
          ...
          <button className="mt-8 flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-[#db2777] hover:gap-4 transition-all">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-8 bg-[#FFF0F5]/50 rounded-[2.5rem] border border-pink-50 text-center">
            <h4 className="text-3xl font-black text-[#db2777]">500+</h4>
            <p className="text-[10px] font-bold text-gray-400 uppercase mt-1">Associates</p>
          </div>
          <div className="p-8 bg-[#db2777] rounded-[2.5rem] text-center shadow-xl shadow-pink-100">
            <h4 className="text-3xl font-black text-[#db2777]">100%</h4>
      ...
      <section className="py-20 max-w-[95%] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 p-10 bg-white rounded-[3rem] border border-pink-100 shadow-sm">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-xl font-black text-[#db2777] uppercase tracking-tighter">Circulars</h3>
          </div>
          <ul className="space-y-6">
            {['New GST Norms for Raw Material', 'e-Auction Schedule Oct 2026', 'Tender Submission Guide'].map((item, i) => (
              <li key={i} className="group cursor-pointer">
                <p className="text-sm font-bold text-[#db2777] group-hover:text-[#db2777] transition-colors">{item}</p>
        ...
        {/* Blog / News */}
        <div className="lg:col-span-2 p-10 bg-[#db2777] rounded-[3rem] text-white overflow-hidden relative">
          <MessageSquare className="absolute -right-10 -bottom-10 text-white/5" size={300} />
          <div className="relative z-10">
            <h3 className="text-2xl font-black mb-6">Textile Industry <span className="text-[#db2777]">Insights</span></h3>
